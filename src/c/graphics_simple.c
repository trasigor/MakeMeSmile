...
void draw_bluetooth_disconnected(GContext *ctx, GColor color_main, GColor color_background, GColor color_middle) {
  ...
  graphics_context_set_stroke_color(ctx, color_middle);
...
void draw_hide_bluetooth(GContext *ctx, GColor color_background) {
  draw_bluetooth_disconnected(ctx, color_background, color_background, color_background);
}